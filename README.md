...
│   ├── __init__.py      # Bronze package initialization
...
│   ├── __init_.py       # Gold package initialization
│   └── models.py        # Pydantic models for validation
├── pipeline/            # Pipeline orchestration
│   ├── init.py          # Pipeline package initialization
│   └── pipeline.py      # Main DocumentParser class
├── data/                # Sample PDF and output files
│   ├── Logistics_Invoice_IN-horus-987103 (1).pdf
│   └── sample-output.json
├── output/              # Generated output files
│   └── output.json      # Pipeline output JSON file
...
The script processes the PDF located at `data/Logistics_Invoice_IN-horus-987103 (1).pdf` and generates a JSON output inside `output` folder.
